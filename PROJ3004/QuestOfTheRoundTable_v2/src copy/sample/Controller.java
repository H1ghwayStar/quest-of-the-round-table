...
//        comboBox1d.getItems().addAll("Normal Mode", "Easy AI", "Difficult AI");
    ...
    public void designingUI(Player player){
        ...
        ImageView scroll = new ImageView("/resources/scroll.jpeg");
...
//        }
    ...
    public void participateInTournament(Player p){
        ...
        Rectangle playerStats = new Rectangle(0,0,800,100);
        playerStats.setTranslateY(-200);
        playerStats.setFill(Color.HOTPINK);
        playerStats.setStroke(Color.BLACK);
        Label label1 = new Label(p.getName() + " If you want to participate in the tournament, Select the cards you want to play and press Yes otherwise press No?");
        label1.setTranslateY(-200);
        Button yesbtn = new Button("Yes");
        yesbtn.setTranslateX(-25);
